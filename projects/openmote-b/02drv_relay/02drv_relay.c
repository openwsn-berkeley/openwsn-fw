/**
\brief This is a program which runs a simple relay. If it recives an input from UART, it turns the mote into a periodic transmitter for that payload. 

\author Mina Rady <mina.rady@orange.com>, October 2021
*/
