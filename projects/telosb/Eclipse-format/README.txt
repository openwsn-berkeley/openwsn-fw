...
Importing TELOSB or other msp430 projects:
-----------------------------------------

- Go into ${openwsn-fw}/projects/telosb and create a copy of the Eclipse-format folder
...
- Select root directory and Browse to ${openwsn-fw}/projects/telosb/OPENWSNECLIPSE and press Finish
