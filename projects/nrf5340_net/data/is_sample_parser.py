...
def aoa_angle_calculation(phase_data, num_pkt):
    ...
    for index in range(64):
        if phase_data[index+1] < phase_data[index]:
            if  index_1 == 0:
                index_1 = index+1
            else:
                index_2 = index+1
    ...
    for index in range(len(data_1)):
        ...
        if diff >= 201:
            diff -= 402
        phase_diff_ant_1_2.append(diff) 
        
    temp.plot(phase_diff_ant_1_2, 'o-', label='ant1.1 and ant1.2')
    ...
    temp.plot(phase_diff_ant_1_3, 'o-', label='ant1.1 and ant1.3')
    temp.legend()
...
with open(sample_file, 'r') as f:
    ...
    for line in f:
        ...
        # determine angles
        result = aoa_angle_calculation(magPhase['phase_data'], num_pkt)
        ...
        i = 8
        ax.plot(time_data[:8*i], magPhase['mag_data'][:8*i], 'k^', label='mag_data_ant1.1')
