openmote-ezr32wg Eclipse project: howto
--------------------------------------
...
Importing openmote-ezr32wg project:
---------------------------------

- Go into ${openwsn-fw}/projects/openmote-ezr32wg and create a copy of the Eclipse-format folder
...
- Select root directory and Browse to ${openwsn-fw}/projects/openmote-ezr32wg/OPENWSNECLIPSE and press Finish
