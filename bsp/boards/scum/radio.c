...
uint16_t freq_setting_rx[16] = {(24<<10 | 19<<5 | 12), 25070, 25265, 25852, 26094, 26286, 26504, 27091, 27306, 27449, 28109, 28252, 28466, 29078, 29291, 29456};
uint16_t freq_setting_tx[16] = {(24<<10 | 19<<5 | 22), 25133, 25749, 25918, 26183, 26377, 26968, 27203, 27840, 28005, 28153, 28364, 28975, 29117, 29376, 29965};
...
void radio_init(void) {
    ...
    printf("rx setting %d tx setting %d\r\n", freq_setting_rx[0] & 0x001f, freq_setting_tx[0] & 0x001f);
