...
// based on derfmega
// time-slot related
#define PORT_TsSlotDuration                 938 //491   // counter counts one extra count, see datasheet
// execution speed related
#define PORT_maxTxDataPrepare               126 //66    // 2014us (measured 746us)
#define PORT_maxRxAckPrepare                20 //10    //  305us (measured  83us)
#define PORT_maxRxDataPrepare               63 //33    // 1007us (measured  84us)
#define PORT_maxTxAckPrepare                20 //10    //  305us (measured 219us)
// radio speed related
#define PORT_delayTx                        14 //7     //  214us (measured 219us)
...
#define TIMER_PRESCALE 1 // 1.90734863f // = 62500/32768
