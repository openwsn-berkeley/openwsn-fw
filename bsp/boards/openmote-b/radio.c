...
{   
 ...
 //RADIOSETTING_24GHZ
    ...
    dyn_funcs [RADIOSETTING_24GHZ].radio_rfOn                  =   radio_rfOn_cc2538rf; 
    dyn_funcs [RADIOSETTING_24GHZ].radio_rfOff                 =   radio_rfOff_cc2538rf; 
    dyn_funcs [RADIOSETTING_24GHZ].radio_getFrequencyOffset    =   radio_getFrequencyOffset_cc2538rf; 
    dyn_funcs [RADIOSETTING_24GHZ].radio_loadPacket            =   radio_loadPacket_cc2538rf; 
    dyn_funcs [RADIOSETTING_24GHZ].radio_txEnable              =   radio_txEnable_cc2538rf; 
    dyn_funcs [RADIOSETTING_24GHZ].radio_txNow                 =   radio_txNow_cc2538rf; 
    dyn_funcs [RADIOSETTING_24GHZ].radio_rxEnable              =   radio_rxEnable_cc2538rf; 
    dyn_funcs [RADIOSETTING_24GHZ].radio_rxNow                 =   radio_rxNow_cc2538rf; 
    dyn_funcs [RADIOSETTING_24GHZ].radio_getReceivedFrame      =   radio_getReceivedFrame_cc2538rf;
    dyn_funcs [RADIOSETTING_24GHZ].radio_isr                   =   radio_isr_cc2538rf; 
}
...
void radio_init (void) {
    ...
    dyn_funcs [RADIOSETTING_24GHZ].radio_init();
}
