...
void uart_init() {
    ...
    //configure USART2 :Baud rate = 115200bit/s, data bit = 8bit, stop bit = 1, no parity, no flow control enable Tx and Rx 
    ...
    // Configure PA.2 as alternate function push-pull
