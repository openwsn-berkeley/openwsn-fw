...
const uint8_t ipAddr_ipsoRD[LENGTH_ADDR128b];
const uint8_t ipAddr_motesEecs[LENGTH_ADDR128b];
const uint8_t ipAddr_local[LENGTH_ADDR128b]; 
const uint8_t ipAddr_motedata[LENGTH_ADDR128b];
const uint8_t ipAddr_ringmaster[LENGTH_ADDR128b];
