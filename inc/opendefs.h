...
#define SIXTOP_CELL_TIMEOUT_RX         25000        //ms before a cell in RX is considered unused if nothing is received
#define SIXTOP_CELL_TIMEOUT_TX         20000        //ms before a cell in TX is considered unused if nothing is transmitted
