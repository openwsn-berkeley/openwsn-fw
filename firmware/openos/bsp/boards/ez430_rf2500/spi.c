/**
\brief eZ430-RF2500-specific definition of the "spi" bsp module.

\author Thomas Watteyne <watteyne@eecs.berkeley.edu>, February 2012.

\Modified by Chuang Qian <cqian@berkeley.edu>, April 2012.
*/
...
void spi_init() {
   ...
   UCB0CTL1   =  UCSWRST;                        // [b0] SWRST=1: Enabled. USART logic held in reset state
   
   // configure SPI-related pins
   P3SEL     |=  0x0f;                           // P3SEL = 0bxxxx1111, CLK/MISO/MOSI/STE pins
   P3OUT     |=  0x01;                           // EN_RF (P3.0) pin is SPI chip select, set high
   P3DIR     |=  0x01;                           // EN_RF (P3.0) pin as output
...
#ifdef SPI_IN_INTERRUPT_MODE
   IE2       |=  UCB0RXIE;                       // we only enable the SPI RX interrupt
