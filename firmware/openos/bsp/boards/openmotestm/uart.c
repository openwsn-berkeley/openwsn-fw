...
void uart_init() 
{
    ...
    // Enable UART4 and GPIOA clock ( for USB-> serial)
    // enable USART1 for normal serial
    ...
    // Configure PC.10 for USB->serial
    ...
    // Configure PC.11 for USB->serial
    GPIO_InitStructure.GPIO_Pin     = GPIO_Pin_10;
    GPIO_InitStructure.GPIO_Speed   = GPIO_Speed_50MHz;
    GPIO_InitStructure.GPIO_Mode    = GPIO_Mode_IN_FLOATING;
    GPIO_Init(GPIOA, &GPIO_InitStructure);
    
    // RTS pin PA.6 as input
    #ifdef UART_USE_RTS
