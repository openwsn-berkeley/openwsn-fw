...
void timers_start(uint8_t      id,		uint16_t     duration,		timer_type_t type,		timer_cbt    callback) {
	...
	case 0:
		...
		timer_set_compare(TIMER_NUM0,TIMER_COMPARE_REG0,current+timers_vars.period[id]);
		break;
	case 1:
		current=timer_get_current_value(TIMER_NUM0);
		timer_set_compare(TIMER_NUM0,TIMER_COMPARE_REG1,current+timers_vars.period[id]);

		break;
	case 2:
		current=timer_get_current_value(TIMER_NUM0);
		timer_set_compare(TIMER_NUM0,TIMER_COMPARE_REG2,current+timers_vars.period[id]);
		break;
	case 3:
		current=timer_get_current_value(TIMER_NUM1);
		timer_set_compare(TIMER_NUM1,TIMER_COMPARE_REG0,current+timers_vars.period[id]);
		break;
	case 4:
		current=timer_get_current_value(TIMER_NUM1);
		timer_set_compare(TIMER_NUM1,TIMER_COMPARE_REG1,current+timers_vars.period[id]);
		break;
	case 5:
		current=timer_get_current_value(TIMER_NUM1);
		timer_set_compare(TIMER_NUM1,TIMER_COMPARE_REG2,current+timers_vars.period[id]);
		break;
	}
}
...
//=========================== interrupt handlers ==============================
/**
 * this is the handler of TIMER_NUM0
 */
void timer_compare_isr_0(uint8_t reg) {
...
/**
 * this is the handler of TIMER_NUM1
 */
void timer_compare_isr_1(uint8_t reg) {
...
/**
 * this is the handler for the capture register on TIMER_NUM0
 */
void timer_capture_isr_0(uint8_t reg) {
...
/**
 * this is the handler for the capture register on TIMER_NUM1
 */
void timer_capture_isr_1(uint8_t reg) {
