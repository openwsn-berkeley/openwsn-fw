...
void icmpv6rpl_timer_DIO_cb() {
   scheduler_push_task(icmpv6rpl_timer_DIO_task,TASKPRIO_SENDDONE_TIMERS_ROUTING);
}
...
void icmpv6rpl_timer_DAO_cb() {
   scheduler_push_task(icmpv6rpl_timer_DAO_task,TASKPRIO_SENDDONE_TIMERS_ROUTING);
}
