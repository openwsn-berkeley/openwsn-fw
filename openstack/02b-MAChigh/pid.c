...
#define PID_PROPORTIONAL_GAIN_VALUE 13000 //  Kp = PID_PROPORTIONAL_GAIN_VALUE / PID_ACCURACY
#define PID_INTEGRAL_GAIN_VALUE         7 //  Ki = PID_INTEGRAL_GAIN_VALUE / PID_ACCURACY
