...
*/
#define SLOTFRAME_LENGTH    101 //should be 101, using 31 so the network synchs faster
...
#define NUMSLOTSOFF          (SLOTFRAME_LENGTH-NUMSERIALRX-SCHEDULE_MINIMAL_6TISCH_ACTIVE_CELLS) //
