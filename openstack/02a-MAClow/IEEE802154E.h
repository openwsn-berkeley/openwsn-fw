...
// 101 slotframe length, 2 cells (0 is in the stream, control slot is added in sixtop_sendEB)
static const uint8_t ebIEsBytestream[] = {
    0x1A,0x88,0x06,0x1A,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x1C,0x00,0x01,
    0xC8,0x00,0x0A,0x1B,0x01,0x00,0x65,0x00,0x02,0x00,0x00,0x00,0x00,0x0F
};
// sfcontrol
//=========================== define ==========================================
